...
export default function Button({
  ...
  const variants = {
    primary: "bg-[#4DFF7C] text-[#0D0D1F] font-bold rounded-md hover:shadow-[-5px_5px_0px_0px_#0d0d1f]",
    purpleShadow: "bg-[#4DFF7C] text-[#0D0D1F] font-bold rounded-md hover:shadow-[-5px_5px_0px_0px_#6600ff]",
    outline:
